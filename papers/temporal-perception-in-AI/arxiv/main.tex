...
\paragraph{RULER Efficiency.} In the RULER Efficiency appendix: across $4$--$32$k contexts, top-$8$ retrieval uses a flat $242$~tok vs.\ a linearly growing full haystack ($2.2$--$18$k~tok), a $1/10$--$1/74$ reduction, preserving recall@1 $1.0$ (Fig.~\ref{fig:ruler}); see also \texttt{figs/ruler\_efficiency.pdf}.
