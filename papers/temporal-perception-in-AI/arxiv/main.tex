...
\caption{Design summary: events carry (wall, mono, $\tau$, fuzz); encoding is
gated by salience at write-time; decay, consolidation, and recall operate on
$\Delta\tau$, not wall-clock; anchor constellations replace flat
chronologies.}
\label{fig:design}
\end{figure}
