\begin{table}[t]\centering\caption{LongMemEval real $n{=}50$ — archival (primary) vs lexical ablation. $acc$ via 70b hybrid judge (meta-llama/llama-3.3-70b-instruct). Local BGE (512tok $\to$ 1200c BATCH8); commodity answer model DeepSeek-V4-Flash; stream-windowed retrieval.}\label{tab:lme50}
