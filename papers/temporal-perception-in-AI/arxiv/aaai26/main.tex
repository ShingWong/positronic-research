...
Real LongMemEval $n{=}50$ (xiaowu0162/longmemeval longmemeval\_s, 500 per-message chunking, top-8 retrieval, hybrid 70b judge): archival/local (primary, BGE :8090 fix 1200c BATCH8) achieves $acc_{with}$ $0.58$ vs $acc_{without}$ $0.14$ ($\Delta$ $0.44$, $p95$ $210$s, fallback $0.0$, recall $1.0$, Table~\ref{tab:lme50}); lexical ablation (balanced/lexical) falls back $1.00$ with $acc$ $0.10$ $\Delta$ $0.00$ and E7 $55/55/35/7$ isolates policy.
