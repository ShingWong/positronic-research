...
\paragraph{RULER Efficiency.} Appendix~\S\ref{app:ruler}: at $32$k context, top-$8$ retrieval uses $242$ vs.\ $4496$~tok---about $1/19$th of the full haystack---preserving accuracy while cutting cost; see also \texttt{figs/ruler\_efficiency.pdf}.
...
\section*{Checklist}
\begin{enumerate}
\item Claims in abstract match experiments (E7 $55/55/35/7$, $n{=}50$, RULER $1/19$th) --- Yes. Justification: E7 table/figure and LongMemEval table included; metrics-50.json provided.
