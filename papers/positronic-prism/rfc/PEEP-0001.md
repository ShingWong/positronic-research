...
| `fuzz_lo` | string\|null | MAY | fuzzy lower interval bound |
| `fuzz_hi` | string\|null | MAY | fuzzy upper interval bound |
...
ordered by τ (ascending or descending; a consumer MUST NOT assume a direction
without inspecting two adjacent `tau` values).
